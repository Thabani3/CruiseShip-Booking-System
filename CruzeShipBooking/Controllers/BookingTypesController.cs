...
namespace CruzeShipBooking.Controllers
{
    public class BookingTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BookingTypeId,BookingTypeName,BookingTypeDescription")] BookingType bookingType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BookingTypeId,BookingTypeName,BookingTypeDescription")] BookingType bookingType)
        {
            if (ModelState.IsValid)
            {
